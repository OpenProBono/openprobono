...
COMPARISON_PROMPT = """You will be given a question, a true answer, and two different generated answers to that question. Your task is to determine which of the two generated answers is better.
...
Carefully analyze the question and both of the answers. Consider the following factors in your analysis:
- Which answer is more directly relevant to answering the specific question asked?
- Which answer provides more detail, nuance and elaboration?
- Which answer, if any, contains inaccurate or false information?
- Which answer is better written and easier to understand?

The output format should look as follows: \"Feedback: {{Write out your analysis and reasoning}} [RESULT] {{1 or 2}}\"
Please do not generate any other opening, closing, and explanations. Be sure to include [RESULT] in your output."""

COMPARISON_PROMPT_2 = """You will be given a question, the true answer to that question, and two answers generated by AI language models in response to the question. Your task is to determine which of the two generated answers is better by carefully comparing them to the true answer.
...
After you have written out your analysis, determine which of the two answers you think is better overall. Remember, do not simply choose the longer answer - a shorter answer that efficiently covers the key points may be better than a longer one that includes extraneous or incorrect information. Focus on accuracy, relevance and completeness relative to the true answer.

The output format should look as follows: \"Feedback: {{Write out your analysis and reasoning}} [RESULT] {{A or B}}\"
Please do not generate any other opening, closing, and explanations. Be sure to include [RESULT] in your output."""